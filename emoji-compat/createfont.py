...
class EmojiFontCreator(object):
    ...
    def create_font(self):
        ...
        with contextlib.closing(ttLib.TTFont(self.font_path, recalcTimestamp=False)) as ttf:
            ...
            flatc_command = 'flatc -o {0} -b -j {1} {2}'.format(tmp_dir, os.path.join(self.flatbuffer_path, FLATBUFFER_SCHEMA), output_json_file)
...
if __name__ == '__main__':
    if len(sys.argv) < 4:
        print_usage()
        sys.exit(1)
    EmojiFontCreator(sys.argv[1], sys.argv[2], sys.argv[3]).create_font()
